...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/MonWebService.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">MonWebService</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="MonWebService.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="MonWebService.asmx?op=CredataTable">CredataTable</a>
              ...
              <li>
                <a href="MonWebService.asmx?op=HelloWorld">HelloWorld</a>
